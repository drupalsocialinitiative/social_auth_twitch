 ...
 * Composer Manager (https://www.drupal.org/project/composer_manager):
   This module will help to install the League PHP library and Twitch base library for the league,
   which are the libraries required to make user authentication.

INSTALLATION
------------

 * Download Twitch Base Library for TheLeague OAuth2 PHP library
   (https://github.com/thephpleague/oauth2-twitch). We recommend to use
...
user to Twitch Accounts for authentication. Twitch then returns the user to
Drupal site. If we have an existing Drupal user with the same email address
provided by Twitch, that user is logged in. Otherwise a new Drupal user is
created.
...
admin/reports/composer-manager. This status page will show the Twitch The League OAuth2 Base
